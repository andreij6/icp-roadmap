...
polling:
  interval_ms: 5000
workspace:
  root: /Users/andrejones/Desktop/workspace/projects
hooks:
  after_create: |
    git clone --depth 1 https://github.com/andreij6/icp-roadmap .
  before_remove: |
...
5.  Ensure the workpad includes a compact environment stamp at the top as a code fence line:
    ...
    - Example: `devbox-01:/home/dev-user/code/icp-roadmap-workspaces/IR-12@7bdde33bc`
...
5.  Run validation/tests required for the scope.
    ...
    - If app-touching, run frontend/canister validation before handoff.
